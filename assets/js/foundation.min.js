      ...
      refresh_custom_select: function (t, n) {
        ...
        if (u.length !== this.cache[s.data('id')] || n)
          s.find('ul').html(''),
            ...
            o.each(function (t) {
              this.selected &&
                (s.find('li').eq(t).addClass('selected'),
                s.find('.current').html(e(this).html())),
                e(this).is(':disabled') &&
                  s.find('li').eq(t).addClass('disabled')
            }),
            s.removeAttr('style').find('ul').removeAttr('style'),
    ...
    var i = function () {},
        ...
        c.children().first().addClass(s.active_slide_class),
          ...
          (f.build_markup = function () {
            c.wrap('<div class="' + s.container_class + '"></div>'),
              ...
              s.navigation_arrows &&
                (l.append(e('<a>').addClass(s.prev_class).append('<span>')),
                l.append(e('<a>').addClass(s.next_class).append('<span>'))),
              s.timer &&
              ...
              s.slide_number &&
                ...
                h.append('<span></span> of <span></span>'),
                l.append(h)),
              s.bullets &&
          ...
          (f._goto = function (t, n) {
            ...
            var o = e(r.get(v)),
              u = e(r.get(t))
            o.css('zIndex', 2),
              u.css('zIndex', 4).addClass('active'),
      ...
      a = function (e) {
        ...
        ;(this.next = function (e, n, r) {
          n.css({ marginLeft: '0%', opacity: '0.01' }),
            n.animate({ opacity: '1' }, t, 'linear', function () {
    ...
    ;(Foundation.libs.section = {
      ...
      toggle_active: function (t) {
        ...
        !u.deep_linking && s.length > 0 && t.preventDefault(),
          t.stopPropagation(),
          i.hasClass(r.settings.active_class)
            ? !u.one_up &&
              (r.small(o) ||
                r.is_vertical_nav(o) ||
      ...
      resize: function (t, r) {
        var i = Foundation.libs.section,
          ...
          o = function (e, t) {
            return (
              !i.is_accordion(e) &&
              !e.is('[' + i.settings.resized_data_attr + ']') &&
              (!s || i.is_horizontal_tabs(e)) &&
              t === (e.css('display') === 'none' || !e.parent().is(':visible'))
            )
          }
        ;(t = t || e(i.settings.section_selector)),
          clearTimeout(i.check_resize_timer),
          s || t.removeAttr(i.settings.small_style_data_attr),
          t
            .filter(function () {
              return o(e(this), !1)
            })
            .each(function () {
              ...
              if (
                ...
                t
                  ...
                  .filter('.' + i.settings.active_class).length == 0
              ) {
                var a = e.extend({}, i.settings, i.data_options(t))
                !a.deep_linking &&
                  (a.one_up ||
                    (!i.is_horizontal_nav(t) &&
                      !i.is_vertical_nav(t) &&
                      !i.is_accordion(t))) &&
                  n.filter(':visible').first().addClass(i.settings.active_class)
              }
              if (i.is_horizontal_tabs(t) || i.is_auto(t)) {
                ...
                s.each(function () {
                  ...
                  if (t.is(':visible')) {
                    ...
                    var n = parseInt(
                      t.css('border-' + (i.rtl ? 'left' : 'right') + '-width'),
                      10
                    )
                    n.toString() === 'Nan' && (n = 0),
                      (f += i.outerWidth(t) - n),
                      (u = Math.max(u, i.outerHeight(t)))
                  }
                }),
                  s.css('height', u),
                  n.each(function () {
                ...
                s.each(function () {
                  ...
                  n.each(function () {
                    ...
                    n.css(
                      'margin-left',
                      '-' +
                        (l ? t : n.children(i.settings.title_selector)).css(
                          'border-left-width'
                        )
                    ),
                      (l = !1)
                  }),
                  n.css('margin-top', '-' + t.css('border-top-width')),
                  s.css('height', u),
                  o.css('top', u),
                  t.css('min-height', u)
                ...
                s.each(function () {
                  ...
                  n.each(function () {
                    ...
                    n.css(
                      'margin-top',
                      '-' +
                        (p ? t : n.children(i.settings.title_selector)).css(
                          'border-top-width'
                        )
                    ),
                      (p = !1)
          ...
          e(i.settings.section_selector).filter(function () {
            ...
            (i.check_resize_timer = setTimeout(function () {
              i.resize(
                t.filter(function () {
                  return o(e(this), !1)
                }),
          ...
          s && t.attr(i.settings.small_style_data_attr, !0)
      },
            ...
            !u &&
              ...
              (i.one_up ||
                (!n.is_horizontal_nav(t) &&
                  !n.is_vertical_nav(t) &&
                  !n.is_accordion(t))) &&
              s.filter(':visible').first().addClass(n.settings.active_class)
        })
      },
      reflow: function () {
              ...
              i.preventDefault(),
                ...
                s.hasClass('expanded')
                  ? s.parent().hasClass('fixed') &&
                    ...
                    n.settings.scrolltop && t.scrollTo(0, 0))
                  : s.hasClass('fixed') &&
            ...
            function (t) {
              if (n.breakpoint()) {
                ...
                i.data('index', i.data('index') + 1),
                  ...
                  i.css(
                    'height',
                    n.outerHeight(r.siblings('ul'), !0) + n.height(o)
                  )
              }
            }
          ),
          ...
          e(this.scope).on(
            ...
            function (t) {
              ...
              i.data('index', i.data('index') - 1),
                ...
                i.data('index') === 0
                  ? i.css('height', '')
                  : i.css('height', n.outerHeight(a, !0) + n.height(s)),
                setTimeout(function () {
                  u.removeClass('moved')
                }, 300)
            }
        ...
        this.settings.$section.detach(),
          this.settings.$section.find('.has-dropdown>a').each(function () {
            ...
            t.settings.custom_back_text == 1
              ? s.find('h5>a').html('&laquo; ' + t.settings.back_text)
      ...
      validate: function (t, n) {
        ...
        while (i--)
          if (!r[i] && /submit/.test(n.type))
            return (
              this.settings.focus_on_invalid && t[i].focus(),
              s.trigger('invalid'),
              e(t[i]).closest('form').attr('data-invalid', ''),
              !1
            )
        return (
